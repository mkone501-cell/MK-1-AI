...
const rules = [
  ...
  { category:'商品', title:'新メニューの決定', topic:/新メニュー/, ending:/新メニュー(?:は|を)[^、。]+に(?:変更する|戻す)ことに決め(?:ました|ます)$/ },
  ...
  { category:'店舗', title:'定休日の決定', topic:/定休日/, ending:/(?:にする|にします|に変更する|に変更します|に決定する|に決定しました|に決める|に決めます|に決めました)$/ },
